...
</li>`).join("");y(),c.insertAdjacentHTML("afterbegin",o),new l(".gallery a",{captionType:"attr",captionsData:"alt",captionDelay:250}).refresh()}const m=document.querySelector(".form"),a=document.querySelector("span");m.addEventListener("submit",d);function d(s){s.preventDefault(),c.innerHTML="";const o=s.target.elements.search.value;o!==""&&(g(),p(o),s.target.reset())}function p(s){const o="https://pixabay.com/api/?",i=new URLSearchParams({key:"34206508-2ad29bd7e91dc1db4e67bd855",q:s,image_type:"photo",orientation:"horizontal",safesearch:!0}),t=o+i;return fetch(t).then(e=>{if(!e.ok)throw new Error(e.status);return e.json()}).then(e=>(e.hits.length===0&&u.error({position:"topRight",message:"Sorry, there are no images matching your search query. Please try again!"}),f(e))).catch(e=>{console.log(e)})}function g(){a.classList.add("loader")}function y(){a&&a.classList.remove("loader")}
